...
fn render(
    ...
    for y in 0..height {
        ...
        // Add per-cell diacritics for each placeholder in the row.
        // Ghostty (and other terminals) require explicit row/column/id
        // diacritics on every U+10EEEE cell, not just the first one.
